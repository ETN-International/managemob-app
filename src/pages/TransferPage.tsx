          ...
          <div className="detail-panel">
            ...
            <div className="detail-sections">
              ...
              <div className="fields-grid">
                ...
                <FR label={t('fld_tr_price')} name="normal_price" value={v('normal_price')} editing={editing} type="number" onChange={handleChange} />
              </div>
