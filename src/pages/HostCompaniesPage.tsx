          ...
          <div className="detail-panel">
            ...
            <div className="detail-sections">
              ...
              <div className="fields-grid">
                ...
                <FR label={t('fld_contact')} name="contact_person" value={d('contact_person')} editing={editing} onChange={handleChange} />
                <FR label={t('fld_email')} name="email" value={d('email')} editing={editing} type="email" onChange={handleChange} />
                <FR label={t('fld_phone')} name="phone" value={d('phone')} editing={editing} onChange={handleChange} />
              </div>
              <div className="detail-section-header">{t('sec_hc_tutor')}</div>
              <div className="fields-grid">
                <FR label={t('fld_tutor')} name="tutor" value={d('tutor')} editing={editing} onChange={handleChange} />
                <FR label={t('fld_tutor_phone')} name="tutor_phone" value={d('tutor_phone')} editing={editing} onChange={handleChange} />
                <FR label={t('fld_tutor_email')} name="tutor_email" value={d('tutor_email')} editing={editing} type="email" onChange={handleChange} />
              </div>
            </div>
          </div>
        ) : (
